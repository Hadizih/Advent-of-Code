...
def main():
    print(count_numbers(transform_values(values)))
    

def transform_values(values):
    values = values.replace("one","one1one")
    values = values.replace("two","two2two")
    values = values.replace("three","three3three")
    values = values.replace("four","four4four")
    values = values.replace("five","five5five")
    values = values.replace("six","six6six")
    values = values.replace("seven","seven7seven")
    values = values.replace("eight","eight8eight")
    values = values.replace("nine","nine9nine")
    values = values.replace("zero","zero0zero")
    return values
